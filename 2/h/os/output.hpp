...
namespace os{
	namespace output{
		...
		inline void apply_write_strategy_random(size_t mpi_rank, F& file, S& status, size_t offset, size_t count, size_t o, size_t size, size_t pixels, P* painter_p, P* painter_c, A& prime){
			if(mpi_rank == 0){
		...
		template<typename F, typename S, typename P, typename A>
		inline void apply_write_strategy_sequential(size_t mpi_rank, size_t mpi_size, F& file, S& status, size_t offset, size_t nth, size_t base_count, size_t o, size_t r, size_t size, size_t pixels, P* painter_p, P* painter_c, A& prime, std::string& file_name){
