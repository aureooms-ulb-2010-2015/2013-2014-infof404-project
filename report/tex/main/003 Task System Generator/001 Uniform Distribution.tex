...
The \emph{lowest common multiple} is exponential in $n$. If we use only the primitive types provided by the \textbf{C++} language we are bounded to a \emph{max} value.
